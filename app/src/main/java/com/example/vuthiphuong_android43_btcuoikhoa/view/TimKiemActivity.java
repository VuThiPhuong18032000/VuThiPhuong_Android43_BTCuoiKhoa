            ...
            try {
                ...
                for(int i=0; i<array.length(); i++) {
                   ...
                   // String search = data.toString().toLowerCase();
                    if(tenSP.toLowerCase().contains(dataTimKiem.toLowerCase())){
                        timKiemList.add(sanPham);
                    }

                }
                adapterTimKiem = new AdapterSanPham(getBaseContext(), timKiemList);
