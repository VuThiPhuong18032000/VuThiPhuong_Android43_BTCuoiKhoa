...
public class QuanAoBeGaiActivity extends AppCompatActivity {
    RecyclerView rcvLoaiQABeGai;
    AdapterSanPham adapterLoaiQABeGai;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quan_ao_be_gai);
        rcvLoaiQABeGai = findViewById(R.id.rcvLoaiQABeGai);
        Button btnBackQABG = findViewById(R.id.btnBackQABG);
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(this,2,RecyclerView.VERTICAL,false);
        rcvLoaiQABeGai.setLayoutManager(layoutManager);

        new DataGetPrduct().execute("https://demo7852048.mockable.io/SanPham");

        btnBackQABG.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                    samPhamNoiBatList.add(samPham);
                    if(maLoai.equals("Loai04")){
                        quanAoBeGaiList.add(sanPham);
                    }

                }
                adapterLoaiQABeGai= new AdapterSanPham(getBaseContext(), quanAoBeGaiList);
                rcvLoaiQABeGai.setAdapter(adapterLoaiQABeGai);
            }
